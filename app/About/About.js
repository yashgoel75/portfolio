...
function About() {
  ...
  const skills = [
    ...
    { name: "TypeScript", defaultSrc: typescript, hoverSrc: typescriptcolor, link: "/ANNandCNN.pdf" },
    { name: "Solidity", defaultSrc: solidity, hoverSrc: soliditycolor, link: "/ANNandCNN.pdf" },
